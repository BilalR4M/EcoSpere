...
class ScheduleService {
  ...
  Future<void> addSchedules() async {
    ...
    List<Map<String, dynamic>> schedules = [
      {
        'date': Timestamp.fromDate(DateTime.parse('2024-10-28T00:00:00Z')),
        'activities': [
          {
      ...
      {
        'date': Timestamp.fromDate(DateTime.parse('2024-10-22T00:00:00Z')),
        'activities': [
          {
      ...
      {
        'date': Timestamp.fromDate(DateTime.parse('2024-10-21T00:00:00Z')),
        'activities': [
          {
        'activity': 'General Waste Collection',
        'city': 'City A',
